...
export const DONOR_PRODUCT_REQUEST = "DONOR_PRODUCT_REQUEST";
export const DONOR_PRODUCT_SUCCESS = "DONOR_PRODUCT_SUCCESS";
export const DONOR_PRODUCT_RESET = "DONOR_PRODUCT_RESET";
export const DONOR_PRODUCT_FAIL = "DONOR_PRODUCT_FAIL";

export const DONATE_PRODUCTS_REQUEST = "DONATE_PRODUCTS_REQUEST";
export const DONATE_PRODUCTS_SUCCESS = "DONATE_PRODUCTS_SUCCESS";
export const DONATE_PRODUCTS_FAIL = "DONATE_PRODUCTS_FAIL";
